...
class _WorldClockScreenState extends State<WorldClockScreen> {
  ...
  String get clockStyle => context.watch<UnitSettingsNotifier>().clockStyleMain;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: clockStyle == "Analog" ? 0 : 10),
                          ...
                          child: Stack(
                            ...
                            children: [
                              ...
                              AnalogClock(
                                ...
                                markingColor: null,
                                hourHandColor: colorTheme.primary,
                                ...
                                centerPointColor: colorTheme.secondary,
